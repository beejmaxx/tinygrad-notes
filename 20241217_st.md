...
For a complete composition rather than isolated operations, follow the [transpose/pad/reduction trace](movement-trace.md#3-rangeification-derive-the-address-and-its-validity). It derives `3*k + i - 4`, checks its validity domain, and shows the actual rangeified UOps. Its regression oracle also exercises reversal, asymmetric padding, and broadcasting over 15 shapes.
